...
export const ProductView: React.FC = () => {
  ...
  const fetchMovements = async () => {
    ...
    try {
      const res = await api.get('/api/products/stock-movements');
  ...
  const handleAdjustStock = async (e: React.FormEvent) => {
    ...
    try {
      await api.post(
        `/api/products/${selectedProduct.id}/adjust-stock`,
        adjustForm
      );
              ...
              {loading ? (
                ...
                movements.map((m) => (
                  <tr key={m.id}>
                    ...
                    <td>
                      <span
                        className={`badge badge-${m.movementType.toLowerCase()}`}
                      >
                        {m.movementType === 'IN' ? (
                          <TrendingUp size={12} />
                        ) : (
              ...
              >
                <div className="form-group">
                  ...
                  <input
                    ...
                    placeholder="e.g. Cables & Fittings"
                  />
                </div>
            ...
            <form onSubmit={handleAdjustStock}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="e.g. Factory shipment, Damaged stock write-off..."
                />
              </div>

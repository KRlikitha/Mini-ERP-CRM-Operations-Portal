...
export const ChallanView: React.FC = () => {
  ...
  const handleConfirmChallan = async (id: string) => {
    if (
      !window.confirm(
        'Confirm this Sales Challan? Stock will be atomically deducted from inventory.'
      )
    ) {
      return;
    }
  ...
  const handleCancelChallan = async (id: string) => {
    if (
      !window.confirm(
        'Cancel this Sales Challan? If confirmed, items will be returned to stock.'
      )
    ) {
      return;
    }
            ...
            >
              ...
              >
                ...
                <div>
                  Status:{' '}
                  <span
                    className={`badge badge-${selectedChallan.status.toLowerCase()}`}
                  >
                    {
